...
-- TRIGGER -- e)
DELIMITER $
create trigger TGR_atualizar_jogadores_final_partida after delete on JogandoPartida
for each row
BEGIN
	UPDATE Partida SET num_jogadores = num_jogadores - 1
    WHERE id_partida = OLD.partida_id;
END $
DELIMITER ;
...
CALL finalizar_participação_jogador(1, 1, '14:30:00');-- João Vitor Campõe Galescky && João Victor Schmidt Leite
...
INSERT INTO JogandoPartida (partida_id, jogador_id, horario_inicio, horario_fim)
VALUES (1, 1, '12:30:00', '14:00:00');
...
CALL finalizar_participação_jogador(2, 2, '10:45:00');